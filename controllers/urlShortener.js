...
var url = "mongodb://admin:admin1@ds139950.mlab.com:39950/short-url";
        ...
        if (userUrl) {
            MongoClient.connect(url, function (err, db) {
                ...
                db.collection("website").find({
                    ...
                    if (result.length > 0) {
                        obj = {
                            "orginal_url": "https://"+req.get('host')+ '/'+result[0]["address"],
                            "short_url": "https://"+req.get('host')+ '/'+result[0]["short_url"]
                        };
                        db.close();
                        res.json(obj);
                    } else {
                        ...
                        async.series([
                            ...
                            function (err, results) {
                                ...
                                obj = {
                                    "orginal_url": "https://"+req.get('host')+ '/' +userUrl,
                                    "short_url": "https://"+req.get('host')+ '/'  +websiteShort
                                };
                                db.close();
                                res.json(obj);
                            });
